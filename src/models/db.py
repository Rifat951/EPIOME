...
#from .bart import BartForTokenClassification, BartModel

from .db import DistilBertForTokenClassification, DistilBertModel
...
class SeekerEncoder(BertPreTrainedModel):
	...
	def set_input_embeddings(self, value):
		self.distilbert.embeddings.word_embeddings = value
...
class BiEncoderAttentionWithRationaleClassification(nn.Module):
	...
	def __init__(self, hidden_dropout_prob=0.2, rationale_num_labels=2, empathy_num_labels=3, hidden_size=768, attn_heads = 1):
		...
		#### change
		self.empathy_classifier = DistilBertClassificationHead(hidden_size = 768)
